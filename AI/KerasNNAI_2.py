...
# Lord MNIST: 70,000 handwitten digit images (28x28 pixels, grayscale)
...
model = keras.Sequential([
    ...
    keras.layers.Dropout(0.2),             # Randomly disable 20% neurons to prevent over
