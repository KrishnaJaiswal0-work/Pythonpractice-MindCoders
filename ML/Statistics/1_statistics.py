...
from scipy import stats     #  open source python library used for scientific, mathematicl,
...
print(f'Medain  (Middle Value): Rs.{median:1f}K')
print(f'Mode    (Most common)   Rs.{mode:.1f}K')
print()

#    Spread - how varied is yhe data?
std = np.std(salaries)              # Standard Deviation
var = np.var(salaries)              # Varience (std squared)
