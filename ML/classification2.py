...
print(f'Desicion Tree Accuracy: {accuracy_score(y_test,dt.predict(X_test))*100:.1f}%')
...
plt.title('Desicion Tree,   Iris Classification'); plt.show()

#   Random Forest , multiple tree vote
